...
import {
  addCategoryProduct,
  categoryProductNameChange
} from "../actions/category-product.action";
      ...
      <fieldset>
        <div className="pure-control-group">
          ...
          <input
            ...
            onChange={event =>
              props.categoryProductNameChange(event.target.value)
            }
            value={props.categoryProduct}
          />
        </div>
        ...
        <button
          ...
          type="reset"
          onClick={event => props.addCategoryProduct()}
        >
          {" "}
