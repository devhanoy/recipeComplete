...
import { addRecipe, addProduct, changeName, changeProduct, changeQuantity, changeUnit, changeStep, addStep } from '../actions/recipe.action'
      ...
      <form className="pure-form pure-form-aligned">
        ...
        <div className="pure-control-group">
          {this.props.products.map((product, index) =>
            <div key={index}>
              ...
              <label>Unite:</label>
              <select onChange={event => this.props.productUnitChange(event.target.value, index)}>
                {product.unitId ? null : <option></option>}
        ...
        <div className="pure-control-group">
          {this.props.steps.map((step, index) =>
            <textarea key={index} value={step} onChange={event => this.props.stepChange(event.target.value, index)}></textarea>
          )}
        </div>
        <button type="reset" className="pure-button" onClick={this.props.addStep}>Ajouter étape</button>
